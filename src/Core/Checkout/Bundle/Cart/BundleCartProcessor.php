...
namespace SadisSamplePlugin\Core\Checkout\Bundle\Cart;
...
use SadisSamplePlugin\Core\Content\Bundle\BundleCollection;
use SadisSamplePlugin\Core\Content\Bundle\BundleEntity;

class BundleCartProcessor implements CartProcessorInterface, CartDataCollectorInterface
{
    public const TYPE = 'sadis-sample-plugin_bundle';
    public const DISCOUNT_TYPE = 'sadis-sample-plugin-bundle-discount';
    public const DATA_KEY = 'sadis_sample_plugin_bundle-';
